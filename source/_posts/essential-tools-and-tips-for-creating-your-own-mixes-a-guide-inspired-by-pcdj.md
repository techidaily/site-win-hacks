---
title: "Essential Tools and Tips for Creating Your Own Mixes: A Guide Inspired by PCDJ"
date: 2024-11-29T17:10:06.415Z
updated: 2024-12-01T04:09:47.398Z
tags:
  - product
categories:
  - pcdj
...
## Essential Tools and Tips for Creating Your Own Mixes: A Guide Inspired by PCDJ

[![](https://i2.wp.com/pcdj.com/wp-content/uploads/2014/03/videomixing_whatdoyouneed1.jpg?resize=648%2C270&ssl=1)](https://i2.wp.com/pcdj.com/wp-content/uploads/2014/03/videomixing%5Fwhatdoyouneed1.jpg?fit=648%2C316&ssl=1 "videomixing_whatdoyouneed")

_**Mixing Music Videos**_ is an excellent way to add excitement to your gigs, offering your client the _total multimedia experience_ and making your event more unique and memorable. This equates to more referrals, and more money in your pocket. It’s a highly competitive DJ market out there, and mixing videos can help set you apart from the pack.

So what do you need to mix music videos?

**VIDEO MIXING SOFTWARE**

[DJ Software](https://tools.techidaily.com/pcdj/products/) that allows for video mixing like [**PCDJ DEX 3**](https://tools.techidaily.com/pcdj/products/) is the defacto way to go today. You have the full gamut of DJ features at your disposal, allowing you to blend and mix videos the same way you mix audio files when you DJ. You can beat-sync, loop, fire off hot cues, add video effects and various transitions from one music video to the next and more. _It’s easier than you think_, all you need is the a MAC or PC that meets the requirements (_more on that below!_) and a commercially viable source for music videos (_more on this later, too!_)

**DJ COMPUTER FOR MIXING VIDEOS**

An off-the-shelf MAC or PC can be used to mix videos successfully, but there are a few very important specifications you need to be conscious of when you splurge on your DJ computer of choice. You also want to make sure your machine is optimized for mixing videos, [_here’s a previous blog post about system optimization_](https://tools.techidaily.com/pcdj/products/) Here is what we recommend for [PCDJ DEX 3](https://tools.techidaily.com/pcdj/products/)(not minimum, but recommended!): 
...
_Also, considering that since HD signal cannot be run over long distances without (very) expensive AV equipment you might consider encoding your videos to a 480p standard. (640 x 480)._

The specification for video mixing that you need to pay attention most to, that many DJs and VJs overlook when going out and purchasing a DJ computer, is the graphics card. A video card with _shared video memory_ does just that – it shares RAM with the rest of the machine, and all operations from the underlying OS to the DJ software itself. This can be too taxing on valuable system resources, and will lead to hiccups in playback and other video mixing limitations. So you want [DEDICATED GRAPHICS MEMORY](http://www.reviversoft.com/blog/2012/01/integrated-vs-dedicated-a-difference-in-graphics/), 512MB or higher is the way to go for trouble-free stable video mixing playback.

**WHAT OTHER HARDWARE IS NEEDED FOR VIDEO MIXING?** 
...
The setting that must be enabled on your MAC or PC that allows you to send the mixed video output ONLY to the secondary display (TV, Monitor or Projector) is _EXTENDED DISPLAY MODE_ (otherwise known as extended desktop). This video [_HERE_](http://youtu.be/RP4tHkyYe48) demonstrates how you do this using a Windows based machine, watch [_THIS_](http://youtu.be/hFI8glfMeXI) video for setting this up on your MAC (also demonstrates the Windows setup too). 

Once you’re in extended display mode, it’s a matter of dragging over the secondary video output window to display 2 and clicking “full screen” when using [DEX 2](https://tools.techidaily.com/pcdj/products/). Now you’re setup to start mixing videos.

**MUSIC VIDEO DOWNLOADS FOR PROFESSIONAL DJS AND VJS**

You’ve got the DJ computer and the[DJ Software](https://tools.techidaily.com/pcdj/products/) for mixing music videos, _now how do you get affordable music videos for professional use?_ 
...
PCDJ has recently teamed up with [_**BPM Supreme**_](https://tools.techidaily.com/pcdj/products/), a top-notch source for music videos for professional DJs/VJs.   _All videos_ are delivered in MP4 format and optimally encoded for high quality and low latency (responsive playback). [BPM Supreme](https://tools.techidaily.com/pcdj/products/) supplies DJs with a variety of genres, exclusive mixes, and DJ tools for use in [PCDJ DEX 3](https://tools.techidaily.com/pcdj/products/). The BPM Supreme subscription service offers a wide selection of hip hop, R&B, dance, rock, 90s, old school, pop, reggae, blends, mashups, and premium DJ video remixes for the club or mobile DJ. 

Simply subscribe and download, drop the music videos into [PCDJ DEX 3](https://tools.techidaily.com/pcdj/products/) and start mixing. 
...
_Please feel free to post any questions you have about mixing music videos in the comment section_.
...
https://i2.wp.com/pcdj.com/wp-content/uploads/2014/03/videomixing\_whatdoyouneed1.jpg?fit=648%2C316&ssl=1 316 648 Ryan Sherr https://www.pcdj.com/wp-content/uploads/2021/07/pcdj-main-logo-2.png Ryan Sherr2014-03-05 18:07:042018-04-24 11:03:59Mixing Music Videos – What do you need?}
